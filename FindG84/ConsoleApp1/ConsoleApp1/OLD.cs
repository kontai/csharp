...
namespace ConsoleApp1
{
    ...
    {
        private static readonly Regex G85Regex = new Regex("^G85.*$", RegexOptions.Compiled);   // 用於匹配以 G85 開頭的行
        private static readonly string OutputFilePath = @"d:\G85finder.txt";    // 輸出檔案路徑
        private static int totalFiles = 0;  // 計數找到的檔案數量
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine($"掃描完成,共找到{totalFiles}個檔案");
            }
