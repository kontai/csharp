...
//dx=0,dy=0,size={2},x_anchor=0,y_anchor=0,rotation=0,mirror=none";
        ...
        public static void FindAllLayers(string job, string step, Dictionary<string, string> layers)
        {
            List<string> signalTMP = new List<string>(); // Temporary list for signal layers
            List<string> outer = new List<string>();
            List<string> signalEmpty = new List<string>(); // Empty signal layers
