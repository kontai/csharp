...
//dx=0,dy=0,size={2},x_anchor=0,y_anchor=0,rotation=0,mirror=none";
        ...
        public static void Add_CCD_Frame(double CenterX, double CenterY,string polarity)
        {
            string mySym = polarity == GenTools.POS_NEG["P"] ? "pnl_ccd_frame_p" : "pnl_ccd_frame_n";
            Gen.COM("add_pad" +
