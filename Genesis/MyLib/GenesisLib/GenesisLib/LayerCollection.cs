...
namespace GenesisLib
{
    public class LayerCollection
    {
        ...
        public List<string> InnerList { get; } = new List<string>();
        ...
        public List<string> Via { get; } = new List<string>();
        public List<string>Tent { get; }= new List<string>();
        public List<string>SmssList { get; }=new List<string>();
