namespace Panel_Script
{
    ...
    /// <para>
    /// <para>
    /// pnl_inn_tag_dr: 內層祭氣孔clearance</para>
    /// inn-pin: 內層靶孔</para>
    /// <para>
    /// pnl_inn_tag_dr_n: 外層祭氣孔clearance</para>
    /// inn-pin: 內層靶孔</para>
    /// </summary>
    public struct MySymbols
    {
        ...
        public string Pnl_Inn_Tag => "pnl_inn_tag";
        public string Pnl_Inn_Tag_Dr => "pnl_inn_tag_dr";
        public string Pnl_Inn_Tag_Dr2 => "pnl_inn_tag_dr2";
        public string Pnl_Inn_Tag_Dr_N => "pnl_inn_tag_dr_n";
        public string Pnl_Inn_Tag_Dr2_N => "pnl_inn_tag_dr2_n";
    }
}