...
namespace Panel_Script
{
    public class Tooling
    {
        ...
        public Tooling(int layerCount, double min_x, double min_y, double max_x, double max_y, double offset_x,
            double offset_y)
        {
            ...
            printPin_outer_x = new List<double>()
            {
                ...
                //右下V
                max_x + 0.2, max_x + 0.2,
                GenTools.DoubleRound((max_x - min_x) / 2) - 0.3,
                GenTools.DoubleRound((max_x - min_x) / 2) - 0.3,
                min_x - 0.2,
                max_x + 0.2,
            };
            ...
            printPin_outer_y = new List<double>()
            {
                ...
                min_y - 0.2,
                max_y + 0.2,
                GenTools.DoubleRound((max_y - min_y) / 2) + 0.3,
                GenTools.DoubleRound((max_y - min_y) / 2) + 0.3,
            };
