...
namespace Panel_Script
{
    ...
    {
        private List<double> printPin_outer_two_x;
        private List<double> printPin_outer_two_y;
        private List<double> printPin_outer_Three＿ｘ;
        private List<double> printPin_outer_Three＿y;

        private List<double> printPin_inner_two_x;
        private List<double> printPin_inner_two_y;
        private List<double> printPin_inner_Three＿ｘ;
        private List<double> printPin_inner_Three＿y;

        public List<double> PrintPin_outer_two_x => printPin_outer_two_x;
        public List<double> PrintPin_outer_two_y => printPin_outer_two_y;
        public List<double> PrintPin_outer_Three＿ｘ => printPin_outer_Three＿ｘ;
        public List<double> PrintPin_outer_Three＿y => printPin_outer_Three＿y;

        public List<double> PrintPin_inner_two_x => printPin_inner_two_x;

        public List<double> PrintPin_inner_two_y => printPin_inner_two_y;

        public List<double> PrintPin_inner_Three＿ｘ => printPin_inner_Three＿ｘ;
        public List<double> PrintPin_inner_Three＿y => printPin_inner_Three＿y;
