...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        public static void RunPanelScript()
        {
            ...
            //create the frame
            Gen.COM($"profile_rect,x1={-frame_dist_x},y1={-frame_dist_y},x2={frame_x+frame_dist_x},y2={frame_y+frame_dist_y}");
            // Create the profile
            Do_Patttern_Fill();
...
/*            if (GenTools.Layer_IsExist(Job, workName, ccd_copper_))
            {
