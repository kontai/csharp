...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        {
            double add_symbol_donut_x1 = GenTools.DoubleRound(Frame_Dist_x - (Wix - Six) / 4);
            double add_symbol_donut_x2 = GenTools.DoubleRound(Frame_Dist_x + (Wix - Six) / 4);
            double add_symbol_donut_y1 = GenTools.DoubleRound(Frame_Dist_y - (Wiy - Siy) / 2 + 0.3);
            double add_symbol_donut_y2 = GenTools.DoubleRound(Frame_Dist_y + (Wiy - Siy) / 2 - 0.3);
