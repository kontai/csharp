...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static double frame_x; //下料邊X
        private static double frame_y; //下料邊Y
        ...
        static MyPanelScript()
        {
            ...
            frame_x = (Wix - s_ix) / 2.0;
            frame_y = (Wiy - s_iy) / 2.0;
        }
        ...
        public static void RunPanelScript()
        {
            ...
            else if (selStep != workName)
            {
                ...
                GenTools.CreateStep(Job, workName, "form", "no", "yes");
                Gen.COM($"create_entity,job={Job},is_fw=no,type=step,fw_type=form,name=work,db=");
