...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        {
            double add_symbol_donut_x1 = GenTools.DoubleRound(Min_x - (Wix - Six) / 4);
            double add_symbol_donut_x2 = GenTools.DoubleRound(Max_x + (Wix - Six) / 4);
            double add_symbol_donut_y1 = GenTools.DoubleRound(Min_y - (Wiy - Siy) / 2 + 0.3);
            double add_symbol_donut_y2 = GenTools.DoubleRound(Max_y + (Wiy - Siy) / 2 - 0.3);
