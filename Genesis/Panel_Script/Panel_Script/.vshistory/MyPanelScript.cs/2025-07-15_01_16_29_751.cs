...
COM add_pad,attributes=no,x=13.801538189,y=10.1156823819,symbol=lay-2
        ...
        ) //限制sr margin往外鋪銅最大距離(0=不限制)
        {
            if (layers.Count > 0)
            {
                ...
                Gen.COM("add_polyline_xy, x ={}, y ={} ");
                COM  -0.7652737205, y = 5.3313252953
                COM add_polyline_xy, x = -0.2753602362, y = 5.3313252953
                COM add_polyline_xy, x = -0.2753602362, y = 5.7653426181
                COM add_polyline_xy, x = -0.7652737205, y = 5.7653426181
                COM add_polyline_xy, x = -0.7652737205, y = 5.3313252953
                COM add_polyline_end, attributes = no, symbol = s200, polarity = positive
