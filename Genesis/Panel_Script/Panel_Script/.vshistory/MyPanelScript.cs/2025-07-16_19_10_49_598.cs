...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        public static void RunPanelScript()
        {
            ...
            Gen.PAUSE($"tent count:{layers.Tent.Count} before create");
            //多層板,建立 t1,v1
            ...
            Gen.PAUSE($"tent count:{layers.Tent.Count} after create");
            ...
            for (int i = 0; i < LayerList.Count; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 3:
                    {
                        ...
                        for (var i1 = 0; i1 < via_tnt_list.Count; i1++)
                        {
                            foreach (var lyr in via_tnt_list[i])
                            {
                                Gen.COM($"affected_layer,name={lyr},mode=single,affected=yes");
