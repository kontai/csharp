...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static void Add_Layer_Frame()
        {
            ...
            double layer_name_text_x = layer_frame_x - 0.073728 + 0.5; //層別名稱文字X
            ...
            for (int i = 0; i < layers.InnerList.Count; i++)
            {
                ...
                if (int.Parse(lyrNum) > 9)
                {
                    ...
                    layer_name_text_y = layer_frame_y + 0.0576 - 0.03 - 0.018;
                }
                else
                {
                    text_size_x = 0.06;
                    text_space_x = 0.0; //層別名稱文字X間距
                    layer_name_text_y = layer_frame_y + 0.0576 - 0.02;
                }
                /*
                 * #10+
