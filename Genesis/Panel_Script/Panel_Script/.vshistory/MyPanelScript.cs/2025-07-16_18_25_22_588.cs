                ...
                switch (i)
                {
                    ...
                    case 3:
                    {
                        if (text_lalyer.Count > 0)
                        {
                            ...
                            int cnt = 0;
                            if (layers.Via.Count > 1)
                            {
                                Gen.COM($"affected_layer,name={layers.Via[1]},mode=single,affected=yes");
                                cnt++;
                            }

                            if (layers.Tent.Count > 1)
                            {
                                Gen.COM($"affected_layer,name={layers.Tent[1]},mode=single,affected=yes");
                                cnt++;
                            }
