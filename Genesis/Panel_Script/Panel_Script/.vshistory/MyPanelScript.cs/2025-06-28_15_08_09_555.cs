...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        public static void AutoPanel()
        {
            ...
            if (auto_angle == "0")
            {
                Gen.COM($"sr_tab_change,line=0,step={auto_step},x={Frame_Dist_x},y={Frame_Dist_y}," +
                        $"nx={Xstep_num},ny={ystep_num},dx={Six + xstep_spec},dy={Siy + ystep_spec}");
            }
            else
            {
                Gen.COM($"sr_tab_change,line=0,step={auto_step},x={Frame_Dist_x},y={Frame_Dist_y + Siy}," +
