        ...
        ) //限制sr margin往外鋪銅最大距離(0=不限制)
        {
            if (layers.Count > 0)
            {
                ...
                if (step_mg_x == 0 && trim_line != "0")
                {
                    ...
                    Gen.COM($"add_polyline_xy, x ={-frame_dist_x}, y ={Wix - frame_dist_y} ");
                    Gen.COM($"add_polyline_xy, x ={Wix - frame_dist_x}, y ={Wix - frame_dist_y} ");
                    Gen.COM($"add_polyline_xy, x ={Wix - frame_dist_x}, y ={-frame_dist_y} ");
                    Gen.COM($"add_polyline_xy, x ={-frame_dist_x}, y ={-frame_dist_y} ");
