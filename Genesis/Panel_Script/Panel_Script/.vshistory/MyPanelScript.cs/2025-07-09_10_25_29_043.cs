...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static void Add_Layer_Frame()
        {
            ...
            double text_size_x = 0.06; //層別名稱文字X大小
            double text_size_y = 0.09; //層別名稱文字Y大小
            int text_angle = 270; //層別名稱文字角度
            double text_space_x = 0.0;
            double text_w_factor = 0.8333; //層別名稱文字寬度因子

            double layer_name_text_x = layer_frame_x - 0.073728 + 0.45; //層別名稱文字X
            double layer_name_text_y = layer_frame_y + 0.0576 - 0.03; //層別名稱文字Y
            ...
            for (int i = 0; i < layers.InnerList.Count; i++)
            {
                ...
                {
                    text_size_x = 0.05;
                    text_space_x = 0.008; //層別名稱文字X間距
                    layer_name_text_y = layer_frame_y + 0.0576 - 0.03; /
                }
                else
                {
                    text_size_x = 0.06;
                    text_space_x = 0.0; //層別名稱文字X間距
                    layer_name_text_y = layer_frame_y + 0.0576 - 0.03; /
                }
                /*
                 * #10+
