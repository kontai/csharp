            ...
            if (layers.Tent.Count > 0)
            {
                ...
                for (int i = 0; i < layers.Tent.Count; i++)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        sym_ang = "0";
                        tent_text = "C";
                        tent_text_x += GenTools.DoubleRound(sym_size / 2 - 0.18);
                        no_mir_text = GenTools.DoubleRound(tent_text_y + tent_text_size+0.4);
                    }
                    else if (i == 1)
                    {
                        mir = "yes";
                        ...
                        sym_ang = "180";
                        tent_text = "S";
                        tent_text_x += GenTools.DoubleRound(sym_size / 2 - 0.06);
                        no_mir_text = GenTools.DoubleRound(tent_text_y - tent_text_size-0.4);
                    }
