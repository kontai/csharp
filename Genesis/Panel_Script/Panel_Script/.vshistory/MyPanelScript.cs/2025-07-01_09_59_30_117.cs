    ...
    public static class MyPanelScript
    {
        ...
        private static void Do_Patttern_Fill()
        {
            ...
            if (isNegOuter || isNegOuter)
            {
                ...
                Gen.COM($"add_surf_poly_seg,x={frame_x + 0.2},y={-0.2}");
        ...
        public static void Add_Inner_Strip()
        {
            ...
            double anchor_center_x = (Six / 2) - frame_dist_x;
            double anchor_center_y = (Siy / 2) - frame_dist_y;
...
// 去除不要的
                ...
                Gen.COM($@"clip_area_end
                                ...
                                ,feat_types=line\;pad\;surface\;arc\;text,ref_layer=$dlt_lyr");
                Gen.COM("clip_area_strt");
                Gen.COM($"clip_area_xy, x = {Six},y = {Siy}");

                    clip_area_xy, x = 0, y = 0
                clip_area_end,layers_mode = layer_name,layer = $dlt_lyr,area = manual,area_type = rectangle,inout =
                    inside,contour_cut = yes,margin = 0,feat_types = line\;
                pad\;
                surface\;
                arc\;
                text,ref_layer = $dlt_lyr
                    affected_layer, name = $dlt_lyr,mode = single,affected = no
            }
        }
    }
}