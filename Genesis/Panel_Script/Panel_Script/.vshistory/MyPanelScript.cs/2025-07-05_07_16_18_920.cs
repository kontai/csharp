...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        public static double Six => DoubleRound(s_ix);  //排板尺寸X

        public static double Siy => DoubleRound(s_iy);  //排板尺寸Y

        public static double Wix => DoubleRound(w_ix);  //下料尺寸X

        public static double Wiy => DoubleRound(w_iy); //下料尺寸Y
        ...
        public static double Frame_x => DoubleRound(frame_x);   //排板尺寸X(包括邊距)
        public static double Frame_y => DoubleRound(frame_y);   //排板尺寸Y(包括邊距)
        public static double Frame_Dist_x => DoubleRound(frame_dist_x); //下料邊X
        public static double Frame_Dist_y => DoubleRound(frame_dist_y); //下料邊Y
        ...
        ///
        /
        public static double DoubleRound(double num) ;
        ...
        public static void RunPanelScript()
        {
            ...
            {
                frame_x = DoubleRound((Six * xstep_num) + ((xstep_num - 1) * xstep_spec));
                frame_dist_x = DoubleRound((Wix - frame_x) / 2.0);
                frame_y = DoubleRound((Siy * ystep_num) + ((ystep_num - 1) * ystep_spec));
                frame_dist_y = DoubleRound((Wiy - frame_y) / 2.0);
                if (frame_dist_x < 0 || frame_dist_y < 0)
                {
                    Gen.PAUSE("Size not correct,please check");
                    // Exit the script if the size is not correct
        ...
        public static void Add_Inner_Strip()
        {
            ...
            double anchor_center_x = DoubleRound((Frame_x / 2)) - frame_dist_x;
            double anchor_center_y = DoubleRound((Frame_y / 2)) - frame_dist_y;
