        ...
        private static void Add_Layer_Frame()
        {
            ...
            for (int i = 0; i < layers.InnerList.Count; i++)
            {
                ...
                if (int.Parse(lyrNum) > 9)
                {
                    if (text_mirr == "no")
                    {
                        layer_name_text_y = layer_frame_y + 0.0576 - 0.03 - 0.018 + step_y;
                    }
                    else
                    {
                        layer_name_text_y = layer_frame_y + 0.0576 - 0.03 + 0.088 + step_y;
                    }
                ...
                else
                {
                    if (text_mirr == "no")
                    {
                    layer_name_text_y = layer_frame_y + 0.0576 - 0.02+step_y;
                    }
                    else
                    {
                    layer_name_text_y = layer_frame_y + 0.0576 - 0.02+0.061+step_y;
