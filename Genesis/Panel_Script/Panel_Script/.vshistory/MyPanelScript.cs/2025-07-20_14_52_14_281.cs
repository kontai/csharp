...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static void Export_Drill_Table_Parameter()
        {
            ...
            using (StreamWriter fw = new StreamWriter($"{exceltmpfile}", append: false))
            {
            ...
            Gen.COM($"disp_snapshot,file=C:/tmp/drill_data/{Job}.jpg,width=0,height=0");
        ...
        private static void Add_Layer_Frame()
        {
            ...
            string sym_ = "";
                ...
                {
                    Gen.COM($"affected_layer,name={},mode=single,affected=yes");
                if(layers.Outer.Contains(lyr))  //外層層別
