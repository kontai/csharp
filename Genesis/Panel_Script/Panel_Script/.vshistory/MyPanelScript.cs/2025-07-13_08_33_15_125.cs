...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        {
            double add_symbol_donut_x1 = GenTools.DoubleRound(min_x - min_x / 4);
            double add_symbol_donut_x2 = GenTools.DoubleRound(max_x + (Wix - max_x) / 4);
            double add_symbol_donut_y1 = GenTools.DoubleRound(min_y - min_y / 2 + 0.3);
            double add_symbol_donut_y2 = GenTools.DoubleRound(max_y + (Wiy - max_y) / 2 - 0.3);
