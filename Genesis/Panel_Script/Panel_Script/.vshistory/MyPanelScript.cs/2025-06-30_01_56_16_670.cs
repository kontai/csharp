    ...
    public static class MyPanelScript
    {
        ...
        private static void Do_Patttern_Fill()
        {
            ...
            if (layers.Inner != null && layers.Inner.Count > 0)
            {
                ...
                GenTools.Add_CCD_Frame(Panel_Center.CenterX, Panel_Center.CenterY, GenTools.POS_NEG["N"]);
                isMultiLyr = true;
            }
            ...
            if (mainWindow.outter_pos.IsChecked == true) //正片流程
            {
                ...
                GenTools.Add_CCD_Frame(Panel_Center.CenterX, Panel_Center.CenterY, GenTools.POS_NEG["P"]);
            }
            else //負片流程
            {
