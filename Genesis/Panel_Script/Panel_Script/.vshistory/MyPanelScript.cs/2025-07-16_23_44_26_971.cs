        ...
        private static void Add_Special_Symbols()
        {
            ...
            if (layers.SolderMask.Count > 0)
            {
                foreach (string sm in layers.SolderMask)
                {
                    ...
                    double dam_text_size = GenTools.DoubleRound(min_dam_size.Length * 0.12);
                    if (layers.Full_Layer_Side[sm] == "top")
                    {
                        Gen.COM("add_pad" +
                                ...
                                $",xscale=1,yscale=1");
                        double no_mir_text = GenTools.DoubleRound(dam_text_y - dam_text_size + 0.35);
                    ...
                    else if (layers.Full_Layer_Side[sm] == "bottom")
                    {
                        ...
                        Gen.COM("add_pad" +
                                ...
                                $",xscale=1,yscale=1");
                        double mir_text = GenTools.DoubleRound(dam_text_y + dam_text_size - 0.35);
                        dam_text_x += GenTools.DoubleRound(sym_size / 2 - 0.12);
                        Gen.COM("add_text" +
