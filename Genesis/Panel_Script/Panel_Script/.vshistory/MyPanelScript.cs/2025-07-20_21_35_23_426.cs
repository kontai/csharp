...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static void Export_Drill_Table_Parameter()
        {
            ...
            ////如果drill_table_info檔案不存在,則建立一個空檔案
            //if (!File.Exists($"{drill_table_info}"))
            //{
            //    if (File.Exists($"{exceltmpfile}"))
            //    {
            //        File.Copy($"{exceltmpfile}",$"{drill_table_info}");
            //    }
            //    else
            //    {
            //        using (StreamWriter fw = new StreamWriter($"{drill_table_info}"))
            //        {
