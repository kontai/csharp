...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static void Add_Special_Symbols()
        {
            ...
            if (layers.Tent.Count > 0)
            {
                double tent_text_x = max_x + 0.35;
                double tent_text_y = min_y + 5.4;
                double sym_size = 0.37;
                ...
                for (int i = 0; i < layers.Tent.Count; i++)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        sym_ang = "0";
                        tent_text = "C";
                        tent_text_x += GenTools.DoubleRound(sym_size / 2 - 0.12);
                        no_mir_text = GenTools.DoubleRound(tent_text_y + tent_text_size);
                    }
                    else if (i == 1)
                    {
                        mir = "yes";
                    ...
                    Gen.COM("add_text" +
                            $",attributes=no,type=string,x={tent_text_x},y={no_mir_text + 0.12}" +
