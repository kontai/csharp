...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        {
            double f_x = (Wix - min_x) / 2;
            double f_y = (Wiy - min_y) / 2;
            double add_symbol_donut_x1 = GenTools.DoubleRound(min_x - (Wix - f_x) / 4);
            double add_symbol_donut_x2 = GenTools.DoubleRound(max_x + (Wix - f_x) / 4);
            double add_symbol_donut_y1 = GenTools.DoubleRound(min_y - (Wiy - f_y) / 2 + 0.3);
            double add_symbol_donut_y2 = GenTools.DoubleRound(max_y + (Wiy - f_y) / 2 - 0.3);
