        ...
        private static void Do_Patttern_Fill()
        {
            ...
            if (layers.Inner != null && layers.Inner.Count > 0)
            {
                ...
                foreach (var layer in layers.Inner)
                {
                    ...
                    if (isOdd % 2 == 0)
                    {
                        GenTools.Add_CCD_Frame(Panel_Center.CenterX, Panel_Center.CenterY, Symbols["inner_ccd_1"]);
                    }
                    else
                    {
                        GenTools.Add_CCD_Frame(Panel_Center.CenterX, Panel_Center.CenterY, Symbols["inner_ccd_2"]);
                    }
                }
