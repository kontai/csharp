    ...
    public static class MyPanelScript
    {
        ...
        private static void Add_Special_Symbols()
        {
            ...
            if (layers.Tent.Count > 0)
            {
                ...
                for (int i = 0; i < layers.Tent.Count; i++)
                {
                    Gen.COM($"affected_layer,name={layers.Tent[i]},mode=single,affected=yes");
                    ...
                    if (i == 0)
                    {
                        ...
                        no_mir_text = GenTools.DoubleRound(tent_text_y + tent_text_size - 0.725);
                    }
                    else if (i == 1)
                    {
                        tent_text = "S";
                    ...
                    Gen.COM($"affected_layer,name={layers.Tent[i]},mode=single,affected=no");
                }
            }
