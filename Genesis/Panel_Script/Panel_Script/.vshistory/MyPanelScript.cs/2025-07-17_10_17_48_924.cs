...
namespace Panel_Script
{
    public static class MyPanelScript
    {
        ...
        private static void Add_Hole_Inspection()
        {
             ...
             Gen.COM("clip_area_xy,x=$max_x,y=$max_y");
	...
	COM filter_set,filter_name=popup,update_popup=no,feat_types=line\;arc
	...
	COM info,out_file=$EZCAM_DIR/tmp/hole,write_mode=replace,args= -t layer -e $JOB/work/find_drill_size_ -d FEATURES -m script,units=inch
	...
	COM delete_layer,layer=find_drill_size_
        }
